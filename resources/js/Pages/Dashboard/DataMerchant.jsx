...
const DataMerchant = () => {
    ...
    const submit = (e) => {
        ...
        put(`/dashboard/data_merchant/${data.account_id}`, {
            onSuccess: () => {
                reset();
            },
        });
    ...
    const handleDelete = (id) => {
        destroy(`/dashboard/data_merchant/${id}`);
                    ...
                    <div className="bg-white p-5 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div className="overflow-x-auto mt-5">
                            <table className="table text-center">
                                ...
                                <tbody>
                                    {Array.isArray(props.data_merchant) &&
                                    props.data_merchant.length > 0 ? (
                                        props.data_merchant.map(
                                            (row, index) => (
                                                <tr key={index}>
                                                    <th>{index + 1}</th>
                                                    <td>
